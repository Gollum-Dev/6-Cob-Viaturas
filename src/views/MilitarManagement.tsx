      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-black text-on-surface uppercase tracking-tight flex items-center gap-2 sm:gap-3">
            <Users className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-primary flex-shrink-0" />
            Gestão de Militares
          </h1>
          <p className="text-[10px] sm:text-xs md:text-sm text-on-surface-variant font-medium mt-1">Gerencie o acesso e credenciais dos militares da unidade.</p>
        </div>
